...
- **Pago com**: assinaturas, despesas fixas e variáveis podem ser marcadas como pagas num cartão. A cobrança entra na fatura certa pela data (depois do fechamento, vai para a próxima) e, quando essa fatura é lançada, deixa de somar separado, porque já está dentro dela. A janela da fatura mostra o que tem dentro e quanto sobra de outras compras. Se você lança as compras do cartão uma a uma, desmarque "Somar a fatura nas despesas" no cartão.
